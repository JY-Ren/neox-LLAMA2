...
class NeoXArgsModel(NeoXArgsTemplate):
    ...
    num_attention_heads_kv: int = 1
    """
    Number of transformer attention heads of key and value.
    """
    ...
    norm: Literal["layernorm", "rmsnorm", "scalenorm", "llamarmsnorm", "apexrmsnorm"] = "layernorm"
    """
    Normalization layer to use. Choose from "layernorm", "rmsnorm", "scalenorm", "llamarmsnorm", "apexrmsnorm".
    """

    deepnorm: bool = False
    """
    Use deepnorm in norm layer
    """

    use_length_scale_in_att: bool = False
    """
    Use length scale in attention layer
    """

    residual_input_norm_scale: float = 0.05
    """
    Residual norm scale coefficient
    """
    ...
    """
    Type of positional embedding to use - choose from 'learned', 'rotary', 'sinusoidal', 'rpe', 'alibi', 'none'
    """
    dynamic_rotary: bool = False
    
    origin_position_embeedings: int = 2048
    """
    original embedding size of pretrained model, used in dynamic_rotary
    """

    ntk:int = 2
    """
    ntk value, used in dynamic_rotary
    """
    ...
    llama_mlp_extend_hidden_size: int = 0
    """
    Hidden size of MLP
    """
...
class NeoXArgsLogging(NeoXArgsTemplate):
    ...
    """
    (for debug yangqi) Whether to log distribution statistics of grad/parma
    """
...
class NeoXArgsOther(NeoXArgsTemplate):
    ...
    """
    Encode attention mask every doc inner a sample if TRUE.
    """

    reset_loss_mask: bool = False
    """
    Mask loss of prompt if TRUE.
    """

    reset_human2eod: bool = False
    """
    Replace human token in labels with eod token if TRUE.
    """

    reset_position_ids: bool = False
    """
    Encode position_id every doc inner a sample if TRUE.
    """
    ...
    skip_train_iteration: list = None
    """
    skip some batch data
    """
...
class NeoXArgsTraining(NeoXArgsTemplate):
    ...
    """
    Use to set megatron_config_path for different exps.
    """
    ...
    """
    List of dataset names of valid datasets
    """
    valid_by_datasets: bool = False
    """
    Whether to show valid results by a list of sub-datasets or a blended datasets.
    """
    ...
    """
    Load model weight only when loading checkpoint.
    """
    ...
    use_finetune_dataset: bool = False
    """
    Load data using finetune dataset
    """

    bot_token_id: int = 58363
    """
    Special token <bot> id
    """

    human_token_id: int = 58362
    """
    Special token <human> id
    """

    mask_token_id: int = 58364
    """
    Special token <mask> id
    """

    use_token_mask: bool = False
    """
    Enable mask in input_id
    """
