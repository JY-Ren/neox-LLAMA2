...
python $CODE_PATH/tools/preprocess_data.py \
    --input /cognitive_comp/wuziwei/task/academicGPT/sub_dataset_pile_nopubarxiv/BookCorpus2.jsonl \
    --jsonl-keys text \
    --output-prefix /cognitive_comp/yangping/data/pretrain_corpus/llama_continue_pretraining/books/data \
