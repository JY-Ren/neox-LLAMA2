...
python $CODE_PATH/tools/preprocess_data.py \
    --input /cognitive_comp/common_data/big_corpus/code_t/sample_80.jsonl \
    --jsonl-keys content \
    --output-prefix /cognitive_comp/yangping/data/pretrain_corpus/llama_continue_pretraining/code/data \
