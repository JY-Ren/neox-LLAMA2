...
python $CODE_PATH/tools/preprocess_data.py \
    --input /cognitive_comp/common_data/big_corpus/zh_unsup_idea/zh_unsup.jsonl \
    --jsonl-keys content \
    --output-prefix /cognitive_comp/yangping/data/pretrain_corpus/llama_continue_pretraining/zijian/data \
